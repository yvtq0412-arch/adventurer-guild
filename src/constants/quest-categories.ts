...
export const PERSONAL_CATEGORIES: QuestCategoryInfo[] = [
  ...
  { id: 'pet_care', label: 'ペットの世話', description: '散歩代行、エサやり、一時預かりなど', icon: '🐕', type: 'personal', withholdingRequired: false },
  { id: 'childcare', label: '子守り・送迎', description: 'お子さんの見守り、習い事の送迎など', icon: '👶', type: 'personal', withholdingRequired: false },
