...
export const PERSONAL_CATEGORIES: QuestCategoryInfo[] = [
  ...
  { id: 'pet_care', label: 'ペットの世話', description: '散歩代行、エサやり、見守りなど（※預かり業務は動物取扱業の登録が必要です）', icon: '🐕', type: 'personal', withholdingRequired: false },
  { id: 'childcare', label: '子守り・送迎', description: 'お子さんの見守り、習い事の送迎など（※医療行為・車での送迎は不可）', icon: '👶', type: 'personal', withholdingRequired: false },
