      ...
      <div className="space-y-8 text-sm leading-relaxed text-gray-600">
        ...
        <Section title="第1条（定義）">
          ...
          <ul>
            ...
            <li><strong>「出品者」（受注者）</strong>：本サービスを通じて依頼を受注し、作業を行うユーザー。本規約における「出品者」は一般的な「受注者」「ワーカー」「フリーランサー」と同義です。</li>
            <li><strong>「取引」（依頼）</strong>：依頼者が本サービス上に投稿する作業依頼。本規約における「取引」は一般的な「依頼」「案件」「タスク」と同義です。</li>
            <li><strong>「出品者プロフィール」（受注者プロフィール）</strong>：出品者の本人確認・スキル・実績をまとめたプロフィール。サービスの受注に必要です。</li>
            <li><strong>「エスクロー」（仮払い・第三者預託）</strong>：取引の安全を確保するため、当社が指定する決済事業者（Stripe, Inc.）を通じて報酬を一時的に預託する仕組み。当社自身が資金を預かるものではありません。作業完了・依頼者の承認後に出品者へ送金されます。</li>
            <li><strong>「サービス利用料」</strong>：本サービスの利用対価として取引金額から差し引かれる手数料（基本15%、ランクにより10%〜15%で変動）</li>
            <li><strong>「ランク」（受注者の信頼度）</strong>：出品者の実績・評価に基づくF〜Sの7段階の信頼度指標。ランクが高いほどサービス利用料が優遇されます。</li>
          </ul>
        </Section>
        ...
        <Section title="第3条（サービスの内容）">
          <ol>
            <li>本サービスは、リアルな作業・サービス（清掃、草取り、引越し、イベント設営等）の依頼者（発注者）と出品者をマッチングするプラットフォームです。</li>
            <li>当社は仲介者として取引の場を提供するものであり、購入者と出品者の間の契約当事者ではありません。</li>
            <li>取引に関する最終的な責任は、購入者と出品者の間に帰属します。</li>
        ...
        <Section title="第4条（エスクロー決済）">
          <ol>
            ...
            <li>エスクロー完了後、サービスは「募集中」状態となり出品者が応募できます。</li>
            <li>出品者が作業完了を報告し、依頼者が承認した時点で報酬が出品者に分配されます。</li>
            <li>分配額は「取引金額 − サービス利用料（サービス利用料 15%〜10%）」です。端数は切り捨て（ギルド側が負担）とします。</li>
            <li>Stripe Connect（振込）を利用するため、出品者は Stripe のオンボーディング（本人確認）が必要です。</li>
          </ol>
        </Section>

        <Section title="第5条（サービス利用料）">
          <ol>
            <li>本サービスの利用対価として、取引金額の15%をサービス利用料として徴収します。出品者のランクに応じて10%〜15%で変動します。</li>
            <li>手数料率は事前告知の上、変更する場合があります。</li>
            <li>手数料は出品者の報酬から差し引かれます（依頼者が支払う金額には含まれません）。</li>
        ...
        <Section title="第6条（源泉徴収）">
          <ol>
            ...
            <li>将来、デザイン・執筆・翻訳等の源泉徴収対象カテゴリが追加された場合は、以下の税率で出品者への報酬から控除されます。<br />
            ...
            <li>出品者が得た報酬に関する所得税の申告・納付は、出品者本人の責任において行ってください。</li>
          </ol>
        </Section>
        ...
        <Section title="第7条（インボイス制度への対応）">
          <ol>
            ...
            <li>適格請求書発行事業者の出品者は、登録番号を登録することで適格請求書の発行が可能です。</li>
        ...
        <Section title="第9条（紛争解決）">
          <ol>
            <li>購入者・出品者間で紛争が生じた場合、まず当事者間での解決を試みてください。</li>
        ...
        <Section title="第10条の2（資格・免許が必要な作業について）">
          ...
          <ol>
            ...
            <li><strong>出品者の自己申告：</strong>出品者は、資格・免許・許認可が必要な作業を受注する場合、当該資格等を現に保有していることを保証するものとします。プロフィールへの資格記載はユーザー自身の自己申告であり、当社はその真正性を審査・保証しません。</li>
            <li><strong>虚偽申告の禁止と責任：</strong>資格・免許を保有していないにもかかわらず、これを保有しているとして受注した場合、依頼者に生じた一切の損害について、当該出品者が全責任を負います。</li>
        ...
        <Section title="第11条（知的財産権）">
          <ol>
            ...
            <li>取引で出品者が制作した成果物の著作権は、別途当事者間での合意に基づきます。</li>
          </ol>
        </Section>
