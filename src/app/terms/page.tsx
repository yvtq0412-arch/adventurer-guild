      ...
      <div className="space-y-8 text-sm leading-relaxed text-gray-600">
        ...
        <Section title="第1条（定義）">
          ...
          <ul>
            ...
            <li><strong>「エスクロー」（仮払い・第三者預託）</strong>：取引の安全を確保するため、当社が一時的に報酬を預かる仕組み。作業完了・承認後に冒険者（受注者）へ送金されます。</li>
            <li><strong>「ギルド手数料」（サービス利用料）</strong>：本サービスの利用対価として取引金額から差し引かれる手数料（基本10%、ランクにより7%〜10%で変動）</li>
        ...
        <Section title="第4条（エスクロー決済）">
          <ol>
            ...
            <li>分配額は「取引金額 − ギルド手数料（サービス利用料）」です。端数は切り捨て（ギルド側が負担）とします。</li>
