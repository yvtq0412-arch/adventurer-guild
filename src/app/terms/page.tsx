      ...
      <div className="space-y-8 text-sm leading-relaxed text-gray-600">
        ...
        <Section title="第1条（定義）">
          ...
          <ul>
            ...
            <li><strong>「依頼者」</strong>：本サービスを通じて作業・サービスを依頼するユーザー</li>
            <li><strong>「冒険者」</strong>：本サービスを通じて依頼を受注するユーザー</li>
            <li><strong>「クエスト」</strong>：依頼者が本サービス上に投稿する作業依頼</li>
            <li><strong>「エスクロー」</strong>：取引の安全を確保するため、当社が一時的に報酬を預かる仕組み</li>
            <li><strong>「ギルド手数料」</strong>：本サービスの利用対価として取引金額から差し引かれる手数料（現在10%）</li>
          </ul>
        </Section>
        ...
        <Section title="第3条（サービスの内容）">
          <ol>
            <li>本サービスは、リアルな作業・サービス（清掃、草取り、引越し、イベント設営等）の依頼者と冒険者をマッチングするプラットフォームです。</li>
            <li>当社は仲介者として取引の場を提供するものであり、依頼者と冒険者の間の契約当事者ではありません。</li>
            <li>取引に関する最終的な責任は、依頼者と冒険者の間に帰属します。</li>
        ...
        <Section title="第4条（エスクロー決済）">
          <ol>
            <li>依頼者はクエスト投稿時に報酬全額をエスクロー（Stripeによる決済預かり）します。</li>
            <li>エスクロー完了後、クエストは「募集中」状態となり冒険者が応募できます。</li>
            <li>冒険者が作業完了を報告し、依頼者が承認した時点で報酬が冒険者に分配されます。</li>
            <li>分配額は「取引金額 − ギルド手数料（10%）」です。端数は切り捨て（ギルド側が負担）とします。</li>
            <li>Stripe Connect（振込）を利用するため、冒険者は Stripe のオンボーディング（本人確認）が必要です。</li>
          </ol>
        </Section>

        <Section title="第5条（ギルド手数料）">
          <ol>
            <li>本サービスの利用対価として、取引金額の10%をギルド手数料として徴収します。</li>
            <li>手数料率は事前告知の上、変更する場合があります。</li>
            <li>手数料は冒険者の報酬から差し引かれます（依頼者が支払う金額には含まれません）。</li>
        ...
        <Section title="第6条（源泉徴収）">
          <ol>
            <li>特定カテゴリの業務（デザイン、執筆、翻訳、特定役務等）について、所得税法に基づき源泉徴収が適用される場合があります。</li>
            <li>源泉徴収が適用される場合、冒険者への報酬から以下の金額が控除されます。<br />
              <span className="text-gray-500 ml-4">・100万円以下の部分：報酬額の10.21%</span><br />
              <span className="text-gray-500 ml-4">・100万円超の部分：報酬額の20.42%</span>
            </li>
            <li>控除した源泉徴収税額は、当社が税務署に納付します。</li>
            <li>支払調書等の必要書類は、法令に基づき適切に発行します。</li>
          </ol>
        </Section>
        ...
        <Section title="第12条（免責事項）">
          <ol>
            <li>当社は、ユーザー間の取引によって生じたトラブル・損害について、当社の故意または重大な過失がある場合を除き、責任を負いません。</li>
            <li>本サービスは現状有姿で提供され、特定目的への適合性・正確性・完全性を保証しません。</li>
